...
def calcresandjac(mdata, param):
    ...
    Bhatv = concatenate((param.R, auxv.conj().T))
    ...
    row_ind = concatenate((II1, II2, II2, II2, II2, II2, II2))
    col_ind = concatenate((JJ1, JJ21, JJ22, JJ23, JJ24, JJ25, JJ26))
    data = concatenate((dBdz, dBdU1, dBdU2, dBdU3, dBdV1, dBdV2, dBdV3))
    M = len(Bhatv)
